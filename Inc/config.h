...
#define BAT_LOW_LVL1            3.4       // gently beeps at this voltage level. [V/cell]
#define BAT_LOW_LVL2_ENABLE     1         // to beep or not to beep, 1 or 0
#define BAT_LOW_LVL2            3.2       // your battery is almost empty. Charge now! [V/cell]
...
#define ADC1_MAX 4100               // max ADC1-value while poti at maximum-position (0 - 4095)
#define ADC2_MIN 0                // min ADC2-value while poti at minimum-position (0 - 4095)
#define ADC2_MAX 3900               // max ADC2-value while poti at maximum-position (0 - 4095)
